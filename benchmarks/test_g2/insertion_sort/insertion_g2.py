    ...
    for i, value in enumerate(L):
        for j in range(i - 1, -1, -1):
            if L[j] > value:
                ...
                # G2: the element before index i is already 
                # smaller or equal, meaning this partition is already sorted
                # break out early
                break
    return L
...
if __name__ == "__main__":
    ...
    sorted_result = insertion_sort_g2(my_list)
