...
def make_tree(dd):
    if dd > 0:
        # G1: assign multiple occurrences of an expression to a variable, then reuse it 
        child = make_tree(dd-1)
        return (child, child)
    return (None, None)
...
def main(n, min_depth=4):
    ...
    # G1: mmd stores the result of (max_depth + min_depth) to be reused, to avoid recalculating each iteration 
