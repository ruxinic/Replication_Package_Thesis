...
def check_tree(node):
    # G3: implementation of early termination logic acts as the termination condition
    l, r = node
    if l is None:
        return 1
...
def main(n, min_depth=4):
    # G3: pre-calculating and storing loop conditions in variables
    ...
    # G3: pre-calculate the loop end condition
    # storing the sum of depths in a variable to avoid re-calculation inside the loop
    mmd = max_depth + min_depth
    
    # G3: using a specific step in range (2) to minimize iterations
