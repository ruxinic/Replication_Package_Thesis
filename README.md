...
This repository contains the full replication package for the BSc thesis *"Towards Energy-Aware Coding for Python-based Applications"* (Ruxandra-Maria Nicu, Vrije Universiteit Amsterdam). The study empirically evaluates the impact of 19 Python optimization guidelines, drawn from 6 families, on both **energy consumption** (RQ0) and **execution time** (RQ1), across 26 benchmarks and 4,080 measured runs.
